        ...
        <nav className="sidebar-nav">
          <ul className="nav">
            ...
            <li className={this.activeRoute("/forms")}>
              <a className="nav-link nav-dropdown-toggle" href="#" onClick={this.handleClick.bind(this)}><i className="icon-puzzle"></i> Forms</a>
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <NavLink to={'/forms/form'} className="nav-link" activeClassName="active"><i className="icon-puzzle"></i> Input form</NavLink>
                </li>
              </ul>
            </li>
